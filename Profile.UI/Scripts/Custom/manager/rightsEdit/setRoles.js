function setRoles(container) {
    ...
    function pickData() {
        ...
        data.Trainees = checkTrainees("value");
    ...
    function saveData() {
        ...
        $(container + " #saveRole:not(.disabled)").on("click", function () {
            ...
            //traineeRoles = JSON.stringify(traineeRoles);

            //sendData(URL, traineeRoles, function (d) {  // URL - url for saving trainees roles and spec

            //    sendCallback("#saveTrainee", traineeRoles.Trainee);
            //    $("#saveOk").modal("show");
