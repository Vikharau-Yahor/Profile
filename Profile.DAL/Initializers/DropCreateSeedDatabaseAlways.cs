...
namespace Profile.DAL.Initializers
{
    public class DropCreateSeedDatabaseAlways : DropCreateDatabaseAlways<ProfileContext>
    {
        ...
        private void AddNewUsers(ProfileContext context)
        {
            ...
            {
                "Фарахов Александр", "Бич Екатерина", "Ахтунг Степан",
        ...
        private void AddTeamRevviews(ProfileContext context)
        {
        ...
        private void AddProjects(ProfileContext context)
        {
            ...
            for (int i = 1; i <= projectsCount; i++)
            {
                ...
                context.Projects.Add(new Project
                {
                    ...
                    StartDate = DateTime.Now.AddMonths(randomMonths).AddDays(Random.Next(1, 24)),
                    FinishDate = DateTime.Now.AddMonths(randomMonths + Random.Next(1, 10)).AddDays(Random.Next(1, 24))
                });
            }
            ...
            foreach (var project in context.Projects)
            {
                ...
                for (int i = 1; i <= groupsCount; i++)
                {
                    context.Groups.Add(new Group
                    {
                        Number = $"{project.Id}.{i}",
                        ProjectId = project.Id,
                        StartDate = project.StartDate.AddMonths(Random.Next(1, 3)).AddDays(Random.Next(1, 24)),
                        FinishDate = project.StartDate.AddMonths(Random.Next(4, 7)),
        ...
        private void AddCurrentProjectData(ProfileContext context)
        {
            ...
            Group group = new Group
            {
                ...
                FinishDate = project.StartDate.AddMonths(Random.Next(3, 6)),
                ProjectId = project.Id,
                TeamPurpose = "Purpose of the team",
                TeamworkDescription = "Description of teamwork"
            };
            ...
            List<Trainee> trainees = new List<Trainee>
            {
                ...
                new Trainee { User = new User { FullName = "Семенов Алексей", Email = "SemenovAleksei@gmail.com" }, SpecializationId = specializations[4].Id, Group = group },
                ...
                new Trainee { User = new User { FullName = "Хилько Роман", Email = "surpriseinmailbox@gmail.com" }, SpecializationId = specializations[2].Id, Group = group },
                new Trainee { User = new User { FullName = "Кузнецов Артур", Email = "artorius01@gmail.com" }, SpecializationId = specializations[1].Id, Group = group },
                new Trainee { User = new User { FullName = "Лемеш Вадим", Email = "freelinerr@gmail.com" }, SpecializationId = specializations[1].Id, Group = group },
                new Trainee { User = new User { FullName = "Вихарев Егор", Email = "shmurgee@mail.ru" }, SpecializationId = specializations[2].Id, Group = group },
            ...
            for (int i = 0; i < trainees.Count; i++)
            {
                ...
                _userManager.CreateAsync(trainees[i].User, $"Password{i + 1}").Wait();
